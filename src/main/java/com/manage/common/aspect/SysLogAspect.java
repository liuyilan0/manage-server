package com.manage.common.aspect;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.manage.common.annotation.SysLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		com.manage.common.annotation.SysLog syslog = method.getAnnotation(com.manage.common.annotation.SysLog.class);
		if(syslog != null){
			//注解上的描述
